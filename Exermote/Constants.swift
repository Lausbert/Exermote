...
let MAXIMUM_TIME_SINCE_UPDATE_BEFORE_DISAPPEARING = 10.0
let MAXIMUM_NUMBER_FOR_CALCULATING_AVERAGE_OF_FREQUENCY = 10
let TIME_UNTIL_BLE_MANAGER_PAUSES_WITH_SCANNING = 30.0
...
let NOTIFICATION_RECORDING_MANAGER_UPDATE_RECORDING_DURATION = "updateRecordingDuration"
let NOTIFICATION_RECORDING_MANAGER_UPDATE_RECORDING_META_DATA = "updateRecordingMetaData"
let NOTIFICATION_RECORDING_MANAGER_UPDATE_RECORDING_PROGRESS_ANGLE = "updateRecordingProgressAngle"
...
let EXERCISE_FIRST_HALF = "firstHalf"
let EXERCISE_SECOND_HALF = "secondHalf"
let EXERCISE_MAXIMUM_REPETITIONS = 10
let EXERCISE_MINIMUM_REPETITIONS = 5

// Mark: ToneOutputUnit Constants

let STARTING_FREQUENCY_EXERCISE = 700.0
let ALERT_FREQUENCY_SET_BREAK = 500.0

// Mark: Firebase Constants

let FIREBASE_SETTINGS = "settings"
let FIREBASE_SETTINGS_RECORDING = "recording"
let FIREBASE_EXERCISES = "exercises"
