...
let RECORDING_DURATION_MAXIMUM:Float = 5.0
let RECORDING_DURATION_MINIMUM:Float = 1.0
let RECORDING_DURATION_STEPS:UInt = 4

let RECORDING_FREQUENCY_MAXIMUM:Float = 10
let RECORDING_FREQUENCY_MINIMUM:Float = 0.2
let RECORDING_FREQUENCY_STEPS:UInt = 98
