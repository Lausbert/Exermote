...
let RECORDING_DURATION_MAXIMUM = 5.0
let RECORDING_DURATION_MINIMUM = 1.0
let RECORDING_DURATION_STEPS = 4
let RECORDING_FREQUENCY_MAXIMUM = 10
let RECORDING_FREQUENCY_MINIMUM = 0.2
let RECORDING_FREQUENCY_STEPS = 98
